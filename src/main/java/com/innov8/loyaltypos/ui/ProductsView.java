...
public class ProductsView {
    ...
    private void openForm(Product editing) {
        ...
        // Supplier dropdown removed per revision — Suppliers page is the dedicated
        // surface. products.supplier_id stays in the schema for future use but isn't
        ...
        save.setOnAction(e -> {
            ...
            // supplier_id no longer editable from this form; existing value is preserved.
